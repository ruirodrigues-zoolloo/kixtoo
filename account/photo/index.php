...
<form action="upload.photo.php" method="post" enctype="multipart/form-data">
    <strong>Select Photo to upload:</strong><br/><br/>
    <input type="file" name="fileToUpload" id="fileToUpload" class="form-control" style="height:auto;"><br/>
    <input type="submit" value="Upload Photo" name="submit" class="btn btn-success btn-sm">
</form>
                </div>
            </div>
        </div>
