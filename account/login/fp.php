    ...
    <body class="animated fadeIn">
        ...
        <div class="container" style="margin-top:75px;">
            <div class="row">
                ...
                <div class="col-md-4">
                    <form id="loginform" style="margin-top:50px;" action="send.reset.php" method="POST">
                        <h3 style="font-weight:100;color:#ff5400;text-align:center;margin-bottom:25px;">Reset Kixtoo Password</h3>
                        <p>
                        Further instructions will be sent to your email address used when you created your account.
                        </p>
                        <p>
                        ...
                        <p align="right">
                            <input type="submit" class="btn btn-warning btn-block" style="background:#ff5400;color:#ffffff;" value="Send Instructions"/>
                        </p>
                    </form>
                </div>
                <div class="col-md-4">
