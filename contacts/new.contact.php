        ...
        <div class="container" style="margin-top:75px;">
            <div class="row">
                ...
                <h4>Add New Contact</h4>
                            <p>
                                Enter the persons email address that you wish to add to your contacts. We will check our system if their email exists, if it doesn't we will send them email letting them know you are inviting them to be one of your contacts on Kixtoo.com.
                            </p>
                            <form action="save.new.contact.php" method="post">
                                <p>
                                    <input type="email" name="contactEmail" id="contactEmail" class="form-control" placeholder="Enter contacts' email address" requried autofocus/>
                                    <input type="hidden" name="userToken" id="userToken" value="<?php echo $user['userToken'];?>"/>
                                    <input type="hidden" name="userEmail" id="userEmail" value="<?php echo $user['userEmail'];?>"/>
                                </p>
                                <p align="right">
                                    <a href="../contacts/" style="display:inline;width:200px;">Cancel</a>
                                    &nbsp;&nbsp;&nbsp;
