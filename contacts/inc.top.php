    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" style="text-align:right;">
                ...
                ?>
                <img src="<?php echo str_replace('../../','../',$_COOKIE['photo']);?>" width="32" class="rounded-circle" >&nbsp;&nbsp;&nbsp;<a style="color:#ff5400;font-size:12px;" href="logout.php">LOGOUT</a>&nbsp;&nbsp;&nbsp;<a style="color:#ff5400;font-size:12px;" href="../account/">ACCOUNT</a>&nbsp;&nbsp;&nbsp;<a style="color:#ff5400;font-size:12px;" href="../support/">SUPPORT</a>
                <?php
                }
                ?>
            </div>
